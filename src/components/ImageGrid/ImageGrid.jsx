...
class ImageGrid extends Component {
    ...
    return (
      <Grid container>
        <Grid
          ...
          style={{ background: `url(${images[0]})`, position: 'relative' }}
        >
          {overlay}
        </Grid>
      </Grid>
  ...
  renderThree(more) {
    ...
    return (
      <Grid contrainer sx={{display: 'flex'}}>
        <Grid
          item
          xs={6}
          md={4}
        ...
        <Grid
          ...
          style={{ background: `url(${conditionalRender ? images[3] : images[4]})`,position: 'relative', display: 'flex' }}
        >
          {overlay}
        </Grid>
      </Grid>
  ...
  renderCountOverlay(more) {
    ...
    return [
      more && <div key="count" className="cover-more"></div>,
      more && (
